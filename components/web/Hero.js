          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
                Create Copy At Scale With{" "}
                <span className="text-blue-700">Generative AI</span>
              </h1>
              <p className="mt-3 text-lg text-gray-800 dark:text-gray-400">
                Introducing a new way for your brand to Create Copy At Scale
                with Generative AI
              </p>
              {/* Buttons */}
              ...
              {/* End Buttons */}
              {/* Review */}
              <div className="mt-7 lg:mt-10 grid grid-cols-2 gap-x-5">
                {/* Review */}
                <div className="py-5">
